        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <ScrollReveal direction="left">
            <div>
              ...
              <div className="mb-10 p-8 border-l-4 border-[#C9A84C] bg-[#F5F7FA] rounded-r-sm">
          ...
          <ScrollReveal direction="right">
            <div className="relative">
              ...
              <img
                src={logoImg}
                alt="FCC Logo Variations"
                className="relative z-10 rounded-sm w-full object-cover bg-gray-50 p-8"
              />
            </div>
          </ScrollReveal>
        </div>
